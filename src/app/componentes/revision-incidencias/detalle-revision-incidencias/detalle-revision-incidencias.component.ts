...
@Component({
  selector: 'app-detalle-revision-incidencias',
  templateUrl:'./detalle-revision-incidencias.component.html',
  styleUrls: ['./detalle-revision-incidencias.component.css']
})
export class DetalleRevisionIncidenciasComponent implements OnInit {
